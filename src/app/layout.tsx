...
export const metadata: Metadata = {
  title: "Thunder Hawks Hockey Team - Champions on Ice",
  description: "Join the Thunder Hawks hockey team family. Experience championship-level hockey with professional training, passionate fans, and community spirit.",
  keywords: "hockey team, Thunder Hawks, ice hockey, sports, championship, professional hockey, season tickets",
  metadataBase: new URL("https://thunderhawks.com"),
  alternates: {
    canonical: "https://thunderhawks.com"
  },
  openGraph: {
    title: "Thunder Hawks Hockey Team - Champions on Ice",
    description: "Join the Thunder Hawks hockey team family. Experience championship-level hockey with professional training, passionate fans, and community spirit.",
    siteName: "Thunder Hawks Hockey",
    images: [
      {
        url: "/uploads/pixabay/540daeb6-abcc-4087-8827-a4d0ffad43aa/1763027216324-pixabay.jpg",
        alt: "Thunder Hawks team in action"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Thunder Hawks Hockey Team - Champions on Ice",
    description: "Join the Thunder Hawks hockey team family. Experience championship-level hockey with professional training, passionate fans, and community spirit.",
    images: ["/uploads/pixabay/540daeb6-abcc-4087-8827-a4d0ffad43aa/1763027216324-pixabay.jpg"]
  },
  robots: {
    index: true,
    follow: true
